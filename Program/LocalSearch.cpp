...
int LocalSearch::interRouteGeneralInsert()
{
	...
	for (int i=0 ; i<4; i++)
	{
		for (int j=0 ; j < 4 ; j++)
		{
			...
			//params->nbMovesTestedOverall += (resultMoves[i][j] < 1.e28);
			//params->nbMovesTestedAfterFilterLB += shouldBeTested[i][j];
		}
	}
...
int LocalSearch::interRoute2Opt ()
{
	...
	//params->nbMovesTestedAfterFilterLB++;
